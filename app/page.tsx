...
const strengths = [
  { title: "Responsibility", text: "私は責任感を持って物事に取り組むことができます。学校の課題やアルバイトなど、任されたことは最後までやり遂げるよう心がけています。" },
  { title: "Continuous Learning", text: "新しい知識や技術を学ぶことが好きです。分からないことがあれば自分で調べながら学習を進め、スキル向上に努めています。" },
  { title: "Problem Solving", text: "課題に直面したときは、原因を考えながら解決方法を探します。プログラミング学習でも、エラーの内容を確認しながら一つずつ解決するようにしています。" },
  { title: "Adaptability", text: "新しい環境にも柔軟に対応できます。ミャンマーから日本へ来て、日本語やプログラミングを学びながら新しい生活に挑戦しています。" },
];
  ...
  return (
    <main className={styles.page} id="top">
      <header className={styles.header}>
        <a className={styles.logo} href="#top" aria-label="トップへ">AT<span>.</span></a>
      ...
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          <p className={styles.eyebrow}><span /> Web Programming Student · Okinawa</p>
      ...
      <section className={styles.about} id="about">
        ...
        <div className={styles.aboutGrid}>
          <h2>学習と制作の<br />ポートフォリオ。</h2>
          <div><p>このポートフォリオサイトは、私の学習成果や制作したWebサイトを紹介するために作成しました。</p><p>現在、専門学校沖縄ビジネス外語学院でWebプログラミングを学んでおり、Web開発に必要な知識や技術を身につけています。</p><p>将来はフルスタックエンジニアとして、多くの人に役立つシステムやサービスを開発できるエンジニアになることを目標としています。</p></div>
        </div>
      </section>

      <section className={styles.profile} id="profile">
        <p className={styles.sectionNumber}>PROFILE</p>
        <div className={styles.profileGrid}>
          <div><p className={styles.bigHello}>はじめまして。</p><h2>AYE THEINGI<span>です。</span></h2></div>
          <div className={styles.profileCopy}><p>ミャンマー出身で、日本に来て1年になります。現在は専門学校沖縄ビジネス外語学院のWebプログラミングコースで学んでいます。</p><p>新しい技術を学ぶことが好きで、HTML、CSS、TypeScript、React、Next.jsを中心に勉強しています。</p><p>責任感を持って最後までやり遂げることを大切にしており、日々学習を続けながらスキルアップに取り組んでいます。</p><dl className={styles.profileFacts}><div><dt>出身</dt><dd>Myanmar</dd></div><div><dt>学習</dt><dd>Web Programming</dd></div><div><dt>目標</dt><dd>Full-Stack Engineer</dd></div></dl></div>
        </div>
      </section>
      ...
      <section className={styles.strengths} id="strengths">
        <div className={styles.sectionTop}><div><p className={styles.sectionNumber}>STRENGTHS</p><h2>私の強み。</h2></div></div>
      ...
      <footer className={styles.footer}><p>© 2026 Aye Theingi</p><p>沖縄でWebプログラミングを勉強中</p><a href="#top">Back to top ↑</a></footer>
    </main>
  );
}
